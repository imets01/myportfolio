      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.data.map((item, index) => (
          <div key={index} className="flex justify-start pt-32 md:gap-10">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-7/12">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-primary text-md md:text-sm font-normal mt-2">
                    {item.description}
                  </p>
                </div>
              </div>
