...
const aboutMeData = {
  ...
  forRecruiters:
    "As an aspiring software engineer with hands-on full-stack development experience using Python, Django, React, and Angular, I bring a versatile skill set to the table. My internship at Valeo honed my practical skills, while my academic background includes working on data science and machine learning projects, such as building neural networks and optimizing data acquisition systems. I'm eager to apply my knowledge and skills to contribute to forward-thinking teams and tackle real-world challenges.",
  forEngineers:
