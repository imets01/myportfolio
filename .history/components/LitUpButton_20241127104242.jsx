...
export const LitUpButton = ({
  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-1 bg-background shadow-md rounded-[13px] relative group transition duration-200 text-foreground hover:bg-transparent hover:text-white">
        {children}
      </div>
    </button>
  );
