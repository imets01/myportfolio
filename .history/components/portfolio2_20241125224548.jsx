      ...
      <main className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            creating robust and scalable web applications. I love turning
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "A React Native mobile app for managing daily tasks",
              },
              {
              ...
              },
              {
                title: "Blog CMS",
                description:
                  "A custom Content Management System built with Python and Django",
              },
            ].map((project, index) => (
              <div
                key={index}
