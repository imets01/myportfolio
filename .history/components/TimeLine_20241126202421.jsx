    ...
    data: [
      {
        ...
        description: [
          ...
          "Informatics minor",
          "Relevant coursework: Data Science, Information Management, Software Systems, Visual Data Analysis, Network Science",
        ],
      },
      {
        year: "Early 2024",
      ...
      },
      {
        ...
        description: [
          ...
          "Artificial Intelligence, Mobile- and Web-based Systems, Cloud Based Software Development, Software Engineering, Client Side Technologies, Database Systems,",
        ],
      },
    ],
  };
