      ...
      <WavyBackground className="sticky">
        <div className="container mx-auto px-4 max-w-4xl ml-2 overflow-x-hidden">
          ...
          <a href="/Akos-Imets-CV.pdf" download>
            <button className="px-8 rounded-lg bg-primary text-primary-foreground font-bold transition duration-200 hover:bg-primary-foreground hover:text-primary border-2 border-transparent hover:border-primary">
              Download CV
            </button>
          </a>
        </div>
